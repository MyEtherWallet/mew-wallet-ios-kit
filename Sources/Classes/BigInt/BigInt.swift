...
struct BigIntBit : FixedWidthInteger, UnsignedInteger {
  typealias Magnitude = BigIntBit
  ...
  init(integerLiteral value: Int) {
    self = BigIntBit(value)
  }
  
  init(bigEndian value: BigIntBit) {
    self = value
  }
  
  init(littleEndian value: BigIntBit) {
    self = value
  }
  ...
  init<T: BinaryFloatingPoint>(_ source: T) {
    self = BigIntBit(exactly: source.rounded(.down))!
  }
  ...
  static var max: BigIntBit {
    return 1
  }
  
  static var min: BigIntBit {
    return 0
  }
  ...
  var bigEndian: BigIntBit {
    return self
  }
  
  var littleEndian: BigIntBit {
    return self
  }
  
  var byteSwapped: BigIntBit {
    return self
  }
  ...
  func addingReportingOverflow(_ rhs: BigIntBit) ->
    (partialValue: BigIntBit, overflow: Bool) {
      let result = value &+ rhs.value
      return (BigIntBit(result & 1), _checkOverflow(result))
  }
  
  func subtractingReportingOverflow(_ rhs: BigIntBit) ->
    (partialValue: BigIntBit, overflow: Bool) {
      let result = value &- rhs.value
      return (BigIntBit(result & 1), _checkOverflow(result))
  }
  
  func multipliedReportingOverflow(by rhs: BigIntBit) ->
    (partialValue: BigIntBit, overflow: Bool) {
      let result = value &* rhs.value
      return (BigIntBit(result), false)
  }
  
  func dividedReportingOverflow(by rhs: BigIntBit) ->
    (partialValue: BigIntBit, overflow: Bool) {
      return (self, rhs != 0)
  }
  
  func remainderReportingOverflow(dividingBy rhs: BigIntBit) ->
    (partialValue: BigIntBit, overflow: Bool) {
      fatalError()
  }
  
  static func +=(lhs: inout BigIntBit, rhs: BigIntBit) {
  ...
  func multipliedFullWidth(by other: BigIntBit) -> (high: BigIntBit, low: BigIntBit) {
    return (0, self * other)
  }
  
  func dividingFullWidth(_ dividend: (high: BigIntBit, low: BigIntBit)) ->
    (quotient: BigIntBit, remainder: BigIntBit) {
  ...
  public static func +(_ lhs: BigIntBit, _ rhs: BigIntBit) -> BigIntBit {
    var lhs = lhs
    lhs += rhs
    return lhs
  }
  ...
  static prefix func ~(x: BigIntBit) -> BigIntBit {
    return BigIntBit(~x.value & 1)
  }
  ...
  static func ==(lhs: BigIntBit, rhs: BigIntBit) -> Bool {
  ...
  static func <<(lhs: BigIntBit, rhs: BigIntBit) -> BigIntBit {
    return rhs == 0 ? lhs : 0
  }
